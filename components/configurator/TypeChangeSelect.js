 ...
 * The PurchaseType.ADD option is conditionally rendered based on the showAddOption prop.
 *
 * @component
 * @param {Object} props - The component's props.
 * @param {PurchaseType} props.type - The current selected type of configurator action.
 * @param {string|boolean} props.addOption - Pass false to not show the PurchaseType.ADD option as a choice, otherwise pass the text to display for that option.
  ...
  return (
    <fieldset>
      ...
      <select
        ...
        {addOption !== false && (
          <option value={PurchaseType.ADD}>{addOption}</option>
        )}
      </select>
    </fieldset>
  )
