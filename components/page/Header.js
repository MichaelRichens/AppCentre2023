...
const Header = () => {
	...
	return (
		<>
			<aside className={headerStyles.textNotice}>
				<p>
					We regret to announce that AppCentre / Second Chance PC Ltd is no longer trading, and orders placed on this
					site will not be processed.
				</p>
				<p>
					Many thanks for your business over the years. To renew your GFI products you can contact Infinigate, GFI's UK
					distributor, at <Link href='mailto:gfi@infinigate.co.uk'>gfi@infinigate.co.uk</Link>, and they will put you in
					touch with a reseller who can help you.
				</p>
			</aside>
