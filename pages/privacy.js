...
const Test = () => {
	return (
		<Page mainClassName='text' title='Privacy Policy'>
			...
			<ul>
				...
				<li>
					<p>
						...
						&quot;Our&quot; in this Agreement) refers to Second Chance PC Ltd, Unit 5, South Cambridgeshire Business
						Park, Sawston, Cambridge, CB22 3JH.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to AppCentre, accessible from{' '}
						<a href='https://www.appcentre.co.uk' rel='external nofollow noopener' target='_blank'>
							https://www.appcentre.co.uk
						</a>
					</p>
				</li>
				<li>
			...
			<ul>
				<li>By email: info@appcentre.co.uk</li>
			</ul>
		</Page>
	)
}
