			...
			<>
				<section>
					...
					<p>
						...
						simple-to-deploy nature makes it a top choice for businesses with limited IT resources, proving that you
						don't need a "big brand" solution to achieve efficiency and productivity.
					</p>
				</section>
				<section>
					...
					<p>
						Kerio Connect goes beyond just an email solution, offering a comprehensive suite of features and
						functionality that rivals more complex and expensive systems. Enjoy seamless integration of email with
						shared calendars, scheduling, contact management, tasks, notes, and shared and public folders. Its instant
						messaging feature is XMPP-compatible, allowing you to use various third-party chat/IM applications on both
					...
					<p>
						The software supports Mac, Windows, or Linux, and provides full support for Outlook (Windows and Mac) and
						many other IMAP or POP compliant email clients. Its web-based administration interface is simple to
						navigate, with the added convenience of configuration from a tablet.
					</p>
					...
					<p>
						...
						automated backup feature, coupled with granular restore options, ensures quick and easy recovery from
					...
					<p>
						...
						boasts a powerful multi-engine anti-virus solution, armed with 14 anti-spam filters and 4 anti-virus
						engines, as well as malware scanning.
					</p>
					<p>
				...
				<section>
					...
					<p>
						Kerio Connect empowers you to organise your contacts into as many groups as necessary and share them with
						your colleagues. Beyond that, the software lets you:
					</p>
					<ul>
					...
					<p>
						...
						your colleagues' online status and chat with them in real-time, making quick back-and-forth conversations
						more efficient. Business users can engage in real-time chats with the Kerio Connect Client or send and
						receive instant messages with their preferred XMPP/Jabber chat client.
					</p>
					...
					<p>
						...
						and tablets. The software allows you to choose the synchronization method that best fits your users,
						ensuring consistency between computer and mobile device data.
					</p>
					<p>
					...
					<p>
						With the cloud-based service called MyKerio, administrators can remain in control of all deployments.
						MyKerio provides 24/7 remote monitoring of your deployments, allowing you to view network, licensing, or
						system critical events as they occur.
					</p>
					<p>
					...
					<ul>
						...
						<li>
							An antivirus engine that minimises the impact on memory and system performance while providing
