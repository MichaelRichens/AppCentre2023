			...
			<article>
				<section>
					<p>
						...
						all-encompassing software not only helps businesses maintain compliance but also significantly improves
						email performance, ultimately reducing costs.
					</p>
				</section>
				<section>
					...
					<ul>
						...
						<li>
							<strong>Remote Access:</strong> Access your email history and business-critical documents from anywhere.
							GFI Archiver allows users to view the archive using any IMAP-enabled device, such as an iPhone, iPad or
							Android, or through a web interface.
						</li>
						<li>
						...
						<li>
							<strong>Compliance and eDiscovery:</strong> GFI Archiver supports compliance standards by archiving
							digital communications in a secure store. The software includes audit-trail functionality for monitoring
							database and user activity, and its search features enable quick data retrieval for eDiscovery or data
							requests.
						</li>
						<li>
						...
						<li>
							...
							administrative tools. If your organization uses virtualized networks, you can install and integrate a
							range of GFI products.
						</li>
						<li>
							<strong>Fax Integration:</strong> Integrate GFI Archiver with GFI FaxMaker to archive faxes and text
							messages along with emails. This consolidation makes your electronic communications history more
				...
				<section>
					...
					<p>
						GFI Archiver isn't just an archiving tool - it's a powerful software solution that brings numerous benefits
						to businesses:
					</p>
					<ul>
						<li>
						...
						<li>
							...
							storing one copy of a multi-recipient email instead of multiple copies, and compressing (and
							decompressing) email attachments to optimise use of your storage resources.
						</li>
						<li>
						...
						<li>
							<strong>Fast Data Retrieval:</strong> With GFI Archiver, accessing your email history and files is quick
							and easy, whether you're on a desktop or mobile device.
						</li>
					</ul>
				</section>
				<section>
					<h2>Testimonials</h2>
					<p>
						GFI Archiver has helped numerous businesses streamline their electronic communications management. Here's
					...
					<blockquote>
						When companies rely on things like legal hold for lawsuits, the ability to quickly find mail from employees
						is a major benefit.
