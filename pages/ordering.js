			...
			<article>
				<section>
					<p>
						...
						possible. To facilitate this, we have tools on all the product pages which allow you to configure a new
						subscription or a modification to an existing one. You can use one of these to select all the details you
						need for your installation, and it will pick the correct tier pricing for your subscription, and give you a
						total price at the bottom - allowing you to make quick comparisons of different options. When you have made
						a decision, you can add the custom configuration straight to the cart and check it out as an order.
					</p>
					<p>
					...
					<p>
						For renewals and modifications you can also in the shopping cart, enter your licence key to link it with the
						configuration - this will help us find your subscription to process the update. If you are not an existing
						customer, we may need to contact you for this information if you do not provide it.
					</p>
