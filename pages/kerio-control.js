...
const Control = (props) => {
	...
	return (
		<ProductInfoPage
			...
			logoSvgSrc='images/logos/kerio-control-logo.svg'
			...
			<section>
				...
				<p>
					Security is a critical and often overlooked element for SMEs. A recent Verizon survey found that 43 percent of
					cyberattacks in 2019 targeted SMEs, forcing 22% of those businesses to halt operations immediately.
				</p>
			</section>
			<section>
				...
				<p>
					...
					system constantly monitors network communications for suspicious activity, logging or blocking communications
					depending on the severity.
				</p>
				<p>
					Kerio Control also offers robust protection against viruses, worms, Trojans, and spyware. It goes beyond just
					checking files for malicious code; it actively scans your network traffic for potential attacks.
				</p>
			</section>
			<section>
				<h2>Secure VPN Connectivity</h2>
				<p>
					Kerio Control allows you to create secure, high-performance server-to-server connections between your offices
					with a straightforward VPN setup. Alternatively, you can establish a secure VPN connection to a remote office
					using industry-standard VPN protocols.
				</p>
			</section>
			<section>
				...
				<p>
					...
					blocking peer-to-peer networks. Manage or block access to 100+ continuously updated categories of content and
					applications with the optional Kerio Control Web Filter.
				</p>
			</section>
			<section>
			...
			<section>
				...
				<ul>
					<li>
						...
						virtual appliance in an existing VMware environment, or a turnkey hardware appliance. This flexibility lets
						you custom spec your own hardware while avoiding conflicting applications and vulnerable system services.
					</li>
					<li>
						...
						firewall and router, Intrusion Detection and Prevention (IPS), gateway anti-virus, VPN, and web content and
						application filtering.
					</li>
					<li>
						<strong>Secure VPN:</strong> Link headquarters to remote users and branch offices securely and easily. Kerio
						Control has its own VPN tunnelling with a simple setup. It requires minimal configuration and provides a
						high-performance network connection. You can also use industry-standard IPsec/L2TP for connectivity from
						mobile devices or third-party firewalls.
					</li>
					<li>
					...
					<li>
						...
						deployments through a complimentary centralised web interface that provides consolidated system information,
						automatic configuration backup, status monitoring, system notifications, and complete remote configuration.
					</li>
					<li>
						<strong>Industry-Leading Web, Content and Application Filtering:</strong> The Kerio Control Web Filter lets
						you allow, deny, or limit the applications, websites, and internet services users can access. It continually
						updates its list of thousands of applications and more than six billion web pages - placing them into more
						than 140 categories. Keep bandwidth-hogging traffic off your network and stop users from visiting sites that
						may contain viruses and spyware. The filter is included in the Kerio Control hardware appliance and as an
						add-on when Kerio Control is deployed as a software or virtual appliance.
					</li>
					<li>
						<strong>Advanced Intrusion Prevention System (IPS):</strong> The Kerio Control IPS adds a transparent layer
						of network protection designed to accurately identify and block attacks while maintaining optimal network
						performance. It protects servers behind the firewall from unauthorised connections and keeps users from
						downloading malicious content or malware. The IPS features Snort-based behaviour analysis and a regularly
						updated database of rules and blocklisted IP addresses from Emerging Threats.
					</li>
					<li>
						<strong>High Availability:</strong> With high availability, if a crash or failure occurs, your second Kerio
						Control machine jumps into action. You have no vulnerability exposure, and your users see no drop of
			...
			<section>
				...
				<p>
					...
					specifications while avoiding conflicting applications and vulnerable system services. All hardware appliances
					include Kerio Antivirus and Kerio Control Web Filter.
				</p>
